    ...
    <section className="glass-card p-6 rounded-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <input
          ...
          className="w-full px-4 py-2.5 rounded-lg bg-foreground/[0.03] border border-foreground/[0.06] focus:border-primary/20 focus:outline-none transition-all text-sm"
          disabled={status === 'loading'}
        />
        <button
          type="submit"
          className="w-full py-2.5 rounded-lg bg-foreground text-background font-bold text-[10px] uppercase tracking-widest hover:opacity-90 transition-all disabled:opacity-50"
          disabled={status === 'loading'}
        >
