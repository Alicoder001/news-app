...
const categories = [
  ...
  },
  {
    ...
    name: 'Dasturlash',
    nameEn: 'Development',
    description: 'Barcha turdagi dasturlash yo\'nalishlari: Web, Mobile, DevOps va boshqalar',
    icon: '💻',
    color: '#10B981',
  },
  {
  ...
  },
  {
    ...
    name: 'Startaplar',
    nameEn: 'Startups',
    description: 'Startaplar, investitsiyalar va venchur bozori yangiliklari',
    icon: '🚀',
    color: '#F43F5E',
  },
];
